...
//	public static final String DATABASE_NAME = "dovesguide.db";
//	public static final int DATABASE_VERSION = 2;
//	
//	public static final String TABLE_NAME = "dove_guide";
//
...
//
//	public static final String CREATE_GUIDE_TABLE = 
//		"CREATE TABLE " + TABLE_NAME + " (" + 
//		"_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
//		DOVE_ID + " TEXT NOT NULL, " +
//		NATIONAL_GRID_REF + " TEXT NOT NULL, " +
//		SN_LAT + " NUMERIC NOT NULL, " +
//		SN_LONG + " NUMERIC NOT NULL, " +
...
//		");";
//
//	public static final String ALTER_GUIDE_TABLE = 
...
//		db.execSQL(DbGuide.CREATE_GUIDE_TABLE);		
//		// TODO: add inserts?
//	}
//
//	@Override
//	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
//		db.execSQL(DbGuide.ALTER_GUIDE_TABLE);
//		onCreate(db);
//	}
//}
